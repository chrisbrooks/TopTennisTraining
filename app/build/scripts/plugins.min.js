...
(function(a, b, c, d, e) {
    ...
    a.fn.fullpage = function(h) {
        ...
        function j() {
            ga.append('<div id="fp-nav"><ul></ul></div>');
            sa = a("#fp-nav");
            sa.addClass(function() {
        ...
        function l() {
            ...
            if (!h.autoScrolling || h.scrollBar) {
                if (!b.hasClass("active")) {
                    ...
                    qa && (b.addClass("active").siblings().removeClass("active"), a.isFunction(h.onLeave) && h.onLeave.call(e, g, k, i), 
                    a.isFunction(h.afterLoad) && h.afterLoad.call(b, j, k), I(j, k - 1), h.anchors.length && (oa = j, 
                    S(n, m, j, k)));
                    clearTimeout(va);
                ...
                h.fitToSection && (clearTimeout(wa), wa = setTimeout(function() {
                    qa && (a(".fp-section.active").is(b) && (na = !0), w(b), na = !1);
                }, 1e3));
            }
        }
        function m(a) {
        ...
        function n(a, b) {
            if (ta[a]) {
                var c, d;
                "down" == a ? (c = "bottom", d = ha.moveSectionDown) : (c = "top", d = ha.moveSectionUp);
        ...
        function o(b) {
            ...
            if (!p(b.target) && q(c)) {
                ...
                var e = m(b);
                qa && !ia && (c = $(c), Aa = c.y, Ba = c.x, b.find(".fp-slides").length && d.abs(za - Ba) > d.abs(ya - Aa) ? d.abs(za - Ba) > f.width() / 100 * h.touchSensitivity && (za > Ba ? ta.right && ha.moveSlideRight() : ta.left && ha.moveSlideLeft()) : h.autoScrolling && d.abs(ya - Aa) > f.height() / 100 * h.touchSensitivity && (ya > Aa ? n("down", e) : Aa > ya && n("up", e)));
            }
        }
        function p(b, c) {
            c = c || 0;
        ...
        function r(a) {
            a = a.originalEvent;
            h.fitToSection && fa.stop();
            q(a) && (a = $(a), ya = a.y, za = a.x);
        }
        function s(a, b) {
        ...
        function t(c) {
            ...
            if (h.autoScrolling) {
                ...
                Ca = e;
                200 < f && (ra = []);
                qa && (e = s(ra, 10), f = s(ra, 70), e >= f && (0 > g ? n("down", c) : n("up", c)));
                return !1;
            }
            h.fitToSection && fa.stop();
        }
        ...
        function w(b, c, d) {
            ...
            if ("undefined" !== typeof e && (c = {
                ...
                localIsResizing: na
            }, !(c.activeSection.is(b) && !na || h.scrollBar && f.scrollTop() === c.dtop))) {
                ...
                aa(a(".fp-section.active").position().top), v(), c.wrapAroundElements = c.activeSection, 
        ...
        function z(b) {
            ...
            aa(a(".fp-section.active").position().top), v());
        }
        function A(b) {
            z(b);
        ...
        function B() {
            if (!xa) {
                ...
                if (c.length) {
                    var d = "undefined" === typeof oa, e = "undefined" === typeof oa && "undefined" === typeof a && !ia;
                    (c && c !== oa && !d || e || !ia && pa != a) && P(c, a);
                }
            }
        }
        function C(a) {
            qa && (a.pageY < Ea ? ha.moveSectionUp() : a.pageY > Ea && ha.moveSectionDown());
            Ea = a.pageY;
        }
        function D(b, c) {
            var d = c.position(), e = c.index(), f = b.closest(".fp-section"), g = f.index(".fp-section"), i = f.data("anchor"), j = f.find(".fp-slidesNav"), k = U(c), l = na;
            if (h.onSlideLeave) {
            ...
            h.css3 ? (d = "translate3d(-" + d.left + "px, 0px, 0px)", G(b.find(".fp-slidesContainer"), 0 < h.scrollingSpeed).css(ba(d)), 
            setTimeout(function() {
                p();
        ...
        function E() {
            ...
            if (ja) {
                ...
                b.is("textarea") || b.is("input") || b.is("select") || (b = f.height(), d.abs(b - Fa) > 20 * d.max(Fa, b) / 100 && (ha.reBuild(!0), 
                Fa = b));
        ...
        function F() {
            if (h.responsive) {
                var b = la.hasClass("fp-responsive");
                f.width() < h.responsive ? b || (ha.setAutoScrolling(!1, "internal"), ha.setFitToSection(!1, "internal"), 
                a("#fp-nav").hide(), la.addClass("fp-responsive")) : b && (ha.setAutoScrolling(ua.autoScrolling, "internal"), 
                ha.setFitToSection(ua.autoScrolling, "internal"), a("#fp-nav").show(), la.removeClass("fp-responsive"));
            }
        }
        function G(a) {
        ...
        function K(a) {
            ...
            b = ma - parseInt(b.css("padding-bottom")) - parseInt(b.css("padding-top"));
        ...
        function N(a) {
            ...
            a = parseInt(b.css("padding-top")) + parseInt(b.css("padding-bottom")), b = ma - a;
            return b;
        }
        function O(a, b) {
            b ? G(la) : la.addClass("fp-notransition");
            la.css(ba(a));
            setTimeout(function() {
                la.removeClass("fp-notransition");
            }, 10);
        }
        function P(b, c) {
            var d;
            ...
            b === oa || d.hasClass("active") ? Q(d, c) : w(d, function() {
                Q(d, c);
            });
        }
        function Q(a, b) {
        ...
        function S(a, b, c, d) {
            ...
            pa = b, T(d + "/" + b)) : ("undefined" !== typeof a && (pa = b), T(c)));
            V();
        }
        function T(a) {
            if (h.recordHistory) location.hash = a; else if (ja || ka) history.replaceState(e, e, "#" + a); else {
        ...
        function V() {
            ...
            c.length && (b = b + "-" + e);
            b = b.replace("/", "-").replace("#", "");
            ga[0].className = ga[0].className.replace(RegExp("\\b\\s?fp-viewing-[^\\s]+\\b", "g"), "");
            ga.addClass("fp-viewing-" + b);
        }
        function W() {
        ...
        function $(a) {
            ...
            ka && q(a) && (b.y = a.touches[0].pageY, b.x = a.touches[0].pageX);
            return b;
        }
        function _(a) {
            ha.setScrollingSpeed(0, "internal");
            D(a.closest(".fp-slides"), a);
            ha.setScrollingSpeed(ua.scrollingSpeed, "internal");
        }
        function aa(a) {
            h.scrollBar ? la.scrollTop(a) : h.css3 ? O("translate3d(0px, -" + a + "px, 0px)", !1) : la.css("top", -a);
        }
        function ba(a) {
            return {
                "-webkit-transform": a,
        ...
        function ca() {
            ...
            la.addClass("fp-notransition");
            la.find(".fp-tableCell, .fp-slidesContainer, .fp-slides").each(function() {
        ...
        var fa = a("html, body"), ga = a("body"), ha = a.fn.fullpage;
        h = a.extend({
            menu: !1,
            anchors: [],
            navigation: !1,
        ...
        (function() {
            ...
            ea("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled"));
            h.continuousVertical && h.scrollBar && (h.continuousVertical = !1, ea("warn", "Option `scrollBar` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled"));
            a.each(h.anchors, function(b, c) {
                (a("#" + c).length || a('[name="' + c + '"]').length) && ea("error", "data-anchor tags can not have the same value as any `id` element on the site (or `name` element for IE).");
            });
        })();
        a.extend(a.easing, {
        ...
        ha.setAutoScrolling = function(b, c) {
            da("autoScrolling", b, c);
            var d = a(".fp-section.active");
            h.autoScrolling && !h.scrollBar ? (fa.css({
                overflow: "hidden",
                height: "100%"
            }), ha.setRecordHistory(h.recordHistory, "internal"), la.css({
                "-ms-touch-action": "none",
                "touch-action": "none"
            }), d.length && aa(d.position().top)) : (fa.css({
                overflow: "visible",
                height: "initial"
            }), ha.setRecordHistory(!1, "internal"), la.css({
                "-ms-touch-action": "",
                "touch-action": ""
            }), aa(0), d.length && fa.scrollTop(d.position().top));
        };
        ha.setRecordHistory = function(a, b) {
            da("recordHistory", a, b);
        };
        ha.setScrollingSpeed = function(a, b) {
            da("scrollingSpeed", a, b);
        };
        ha.setFitToSection = function(a, b) {
            da("fitToSection", a, b);
        };
        ha.setMouseWheelScrolling = function(a) {
        ...
        ha.setAllowScrolling = function(b, c) {
        ...
        ha.reBuild = function(b) {
            if (!la.hasClass("fp-destroyed")) {
                ...
                na = !1;
                a.isFunction(h.afterResize) && b && h.afterResize.call(la);
                a.isFunction(h.afterReBuild) && !b && h.afterReBuild.call(la);
            }
        };
        var ia = !1, ja = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/), ka = "ontouchstart" in b || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints, la = a(this), ma = f.height(), na = !1, oa, pa, qa = !0, ra = [], sa, ta = {
            up: !0,
            down: !0,
            left: !0,
            right: !0
        }, ua = a.extend(!0, {}, h);
        ha.setAllowScrolling(!0);
        la.removeClass("fp-destroyed");
        h.css3 && (h.css3 = W());
        a(this).length ? (la.css({
            height: "100%",
            position: "relative"
        }), la.addClass("fullpage-wrapper")) : ea("error", "Error! Fullpage.js needs to be initialized with a selector. For example: $('#myContainer').fullpage();");
        ...
        a(".fp-section").each(function(b) {
            ...
            ha.setAutoScrolling(h.autoScrolling, "internal");
            ...
            h.fixedElements && h.css3 && a(h.fixedElements).appendTo(ga);
            h.navigation && (sa.css("margin-top", "-" + sa.height() / 2 + "px"), sa.find("li").eq(a(".fp-section.active").index(".fp-section")).find("a").addClass("active"));
            h.menu && h.css3 && a(h.menu).closest(".fullpage-wrapper").length && a(h.menu).appendTo(ga);
            h.scrollOverflow ? ("complete" === c.readyState && k(), f.on("load", k)) : a.isFunction(h.afterRender) && h.afterRender.call(la);
            F();
            if (!h.animateAnchor && (d = b.location.hash.replace("#", "").split("/")[0], d.length)) {
                var e = a('[data-anchor="' + d + '"]');
                e.length && (h.autoScrolling ? aa(e.position().top) : (aa(0), fa.scrollTop(e.position().top)), 
        ...
        var va, wa, xa = !1;
        f.on("scroll", l);
        var ya = 0, za = 0, Aa = 0, Ba = 0, Ca = new Date().getTime();
        f.on("hashchange", B);
        ...
        var Da;
        la.mousedown(function(a) {
            2 == a.which && (Ea = a.pageY, la.on("mousemove", C));
        });
        la.mouseup(function(a) {
            2 == a.which && la.off("mousemove");
        });
        var Ea = 0;
        ...
        h.normalScrollElements && (g.on("mouseenter", h.normalScrollElements, function() {
            ha.setMouseWheelScrolling(!1);
        }), g.on("mouseleave", h.normalScrollElements, function() {
            ha.setMouseWheelScrolling(!0);
        }));
        a(".fp-section").on("click touchstart", ".fp-controlArrow", function() {
            a(this).hasClass("fp-prev") ? ha.moveSlideLeft() : ha.moveSlideRight();
        });
        f.resize(E);
        var Fa = ma, Ga;
        ha.destroy = function(b) {
            ha.setAutoScrolling(!1, "internal");
            ha.setAllowScrolling(!1);
            ha.setKeyboardScrolling(!1);
            la.addClass("fp-destroyed");

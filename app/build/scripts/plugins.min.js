...
window.Modernizr = function(a, b, c) {
    ...
    var i = "2.8.3", j = {}, k = b.documentElement, l = "modernizr", m = b.createElement(l), n = m.style, o, p = {}.toString, q = " -webkit- -moz- -o- -ms- ".split(" "), r = {}, s = {}, t = {}, u = [], v = u.slice, w, x = function(a, c, d, e) {
        var f, g, h, i, j = b.createElement("div"), m = b.body, n = m || b.createElement("body");
        if (parseInt(d, 10)) while (d--) h = b.createElement("div"), h.id = e ? e[d] : l + (d + 1), 
        j.appendChild(h);
    ...
    !f(y, "undefined") && !f(y.call, "undefined") ? z = function(a, b) {
        return y.call(a, b);
    } : z = function(a, b) {
        ...
        var c = v.call(arguments, 1), d = function() {
            if (this instanceof d) {
                var e = function() {};
                e.prototype = b.prototype;
                var f = new e(), g = b.apply(f, c.concat(v.call(arguments)));
                return Object(g) === g ? g : f;
            }
            return b.apply(a, c.concat(v.call(arguments)));
        };
        return d;
    }), r.touch = function() {
        var c;
        return "ontouchstart" in a || a.DocumentTouch && b instanceof DocumentTouch ? c = !0 : x([ "@media (", q.join("touch-enabled),("), l, ")", "{#modernizr{top:9px;position:absolute}}" ].join(""), function(a) {
            c = a.offsetTop === 9;
        }), c;
    };
    for (var A in r) z(r, A) && (w = A.toLowerCase(), j[w] = r[A](), u.push((j[w] ? "" : "no-") + w));
    return j.addTest = function(a, b) {
        if (typeof a == "object") for (var d in a) z(a, d) && j.addTest(d, a[d]); else {
            a = a.toLowerCase();
            if (j[a] !== c) return j;
            b = typeof b == "function" ? b() : b, typeof enableClasses != "undefined" && enableClasses && (k.className += " " + (b ? "" : "no-") + a), 
            j[a] = b;
        }
        return j;
    }, d(""), m = o = null, function(a, b) {
        function c(a, b) {
        ...
        var j = "3.7.0", k = a.html5 || {}, l = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, m = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, n, o = "_html5shiv", p = 0, q = {}, r;
        (function() {
            try {
                var a = b.createElement("a");
                a.innerHTML = "<xyz></xyz>", n = "hidden" in a, r = a.childNodes.length == 1 || function() {
                    b.createElement("a");
        ...
        a.html5 = s, i(b);
    }(this, b), j._version = i, j._prefixes = q, j.testStyles = x, j;
...
(function(a, b, c, d, e) {
    ...
    a.fn.fullpage = function(h) {
        function i(a) {
            ...
            "#fff" != h.controlArrowColor && (a.find(".fp-controlArrow.fp-next").css("border-color", "transparent transparent transparent " + h.controlArrowColor), 
            a.find(".fp-controlArrow.fp-prev").css("border-color", "transparent " + h.controlArrowColor + " transparent transparent"));
            h.loopHorizontal || a.find(".fp-controlArrow.fp-prev").hide();
        }
        function j() {
            gb.append('<div id="fp-nav"><ul></ul></div>');
            sb = a("#fp-nav");
            sb.addClass(function() {
            ...
            for (var b = 0; b < a(".fp-section").length; b++) {
                ...
                var c = '<li><a href="#' + c + '"><span></span></a>', d = h.navigationTooltips[b];
                "undefined" !== typeof d && "" !== d && (c += '<div class="fp-tooltip ' + h.navigationPosition + '">' + d + "</div>");
                c += "</li>";
                sb.find("ul").append(c);
            }
        }
        function k() {
            ...
            a.isFunction(h.afterRender) && h.afterRender.call(this);
        }
        function l() {
            var b;
            ...
            if (!h.autoScrolling || h.scrollBar) {
                if (!b.hasClass("active")) {
                    ...
                    if (l.length) var m = l.data("anchor"), n = l.index();
                    qb && (b.addClass("active").siblings().removeClass("active"), a.isFunction(h.onLeave) && h.onLeave.call(e, g, k, i), 
                    a.isFunction(h.afterLoad) && h.afterLoad.call(b, j, k), I(j, k - 1), h.anchors.length && (ob = j, 
                    S(n, m, j, k)));
                    clearTimeout(vb);
                ...
                h.fitToSection && (clearTimeout(wb), wb = setTimeout(function() {
                    qb && (a(".fp-section.active").is(b) && (nb = !0), w(b), nb = !1);
                }, 1e3));
            }
        }
        function m(a) {
        ...
        function n(a, b) {
            if (tb[a]) {
                var c, d;
                "down" == a ? (c = "bottom", d = hb.moveSectionDown) : (c = "top", d = hb.moveSectionUp);
                if (0 < b.length) if (c = "top" === c ? !b.scrollTop() : "bottom" === c ? b.scrollTop() + 1 + b.innerHeight() >= b[0].scrollHeight : void 0, 
                c) d(); else return !0; else d();
            }
        }
        function o(b) {
            ...
            if (!p(b.target) && q(c)) {
                ...
                var e = m(b);
                qb && !ib && (c = $(c), Ab = c.y, Bb = c.x, b.find(".fp-slides").length && d.abs(zb - Bb) > d.abs(yb - Ab) ? d.abs(zb - Bb) > f.width() / 100 * h.touchSensitivity && (zb > Bb ? tb.right && hb.moveSlideRight() : tb.left && hb.moveSlideLeft()) : h.autoScrolling && d.abs(yb - Ab) > f.height() / 100 * h.touchSensitivity && (yb > Ab ? n("down", e) : Ab > yb && n("up", e)));
            }
        }
        function p(b, c) {
            c = c || 0;
            var d = a(b).parent();
            return c < h.normalScrollElementTouchThreshold && d.is(h.normalScrollElements) ? !0 : c == h.normalScrollElementTouchThreshold ? !1 : p(d, ++c);
        }
        function q(a) {
        ...
        function r(a) {
            a = a.originalEvent;
            h.fitToSection && fb.stop();
            q(a) && (a = $(a), yb = a.y, zb = a.x);
        }
        function s(a, b) {
        ...
        function t(c) {
            ...
            if (h.autoScrolling) {
                c = b.event || c;
                var f = c.wheelDelta || -c.deltaY || -c.detail, g = d.max(-1, d.min(1, f));
                149 < rb.length && rb.shift();
                rb.push(d.abs(f));
                ...
                Cb = e;
                200 < f && (rb = []);
                qb && (e = s(rb, 10), f = s(rb, 70), e >= f && (0 > g ? n("down", c) : n("up", c)));
                return !1;
            }
            h.fitToSection && fb.stop();
        }
        function u(b) {
            ...
            if (c.length && !ib) {
                var d = c.find(".fp-slide.active"), e = null, e = "prev" === b ? d.prev(".fp-slide") : d.next(".fp-slide");
                if (!e.length) {
        ...
        function w(b, c, d) {
            ...
            if ("undefined" !== typeof e && (c = {
                ...
                localIsResizing: nb
            }, !(c.activeSection.is(b) && !nb || h.scrollBar && f.scrollTop() === c.dtop))) {
                if (c.activeSlide.length) var g = c.activeSlide.data("anchor"), i = c.activeSlide.index();
                h.autoScrolling && h.continuousVertical && "undefined" !== typeof c.isMovementUp && (!c.isMovementUp && "up" == c.yMovement || c.isMovementUp && "down" == c.yMovement) && (c.isMovementUp ? a(".fp-section.active").before(c.activeSection.nextAll(".fp-section")) : a(".fp-section.active").after(c.activeSection.prevAll(".fp-section").get().reverse()), 
                ab(a(".fp-section.active").position().top), v(), c.wrapAroundElements = c.activeSection, 
                c.dest = c.element.position(), c.dtop = c.dest.top, c.yMovement = J(c.element));
                b.addClass("active").siblings().removeClass("active");
                qb = !1;
                S(i, g, c.anchorLink, c.sectionIndex);
                a.isFunction(h.onLeave) && !c.localIsResizing && h.onLeave.call(c.activeSection, c.leavingSection, c.sectionIndex + 1, c.yMovement);
                x(c);
                ob = c.anchorLink;
        ...
        function x(b) {
            if (h.css3 && h.autoScrolling && !h.scrollBar) O("translate3d(0px, -" + b.dtop + "px, 0px)", !0), 
            setTimeout(function() {
                A(b);
            }, h.scrollingSpeed); else {
                var c = y(b);
        ...
        function y(a) {
            var b = {};
            h.autoScrolling && !h.scrollBar ? (b.options = {
                top: -a.dtop
        ...
        function z(b) {
            b.wrapAroundElements && b.wrapAroundElements.length && (b.isMovementUp ? a(".fp-section:first").before(b.wrapAroundElements) : a(".fp-section:last").after(b.wrapAroundElements), 
            ab(a(".fp-section.active").position().top), v());
        }
        function A(b) {
            z(b);
        ...
        function B() {
            if (!xb) {
                var a = b.location.hash.replace("#", "").split("/"), c = a[0], a = a[1];
                if (c.length) {
                    var d = "undefined" === typeof ob, e = "undefined" === typeof ob && "undefined" === typeof a && !ib;
                    (c && c !== ob && !d || e || !ib && pb != a) && P(c, a);
                }
            }
        }
        function C(a) {
            qb && (a.pageY < Eb ? hb.moveSectionUp() : a.pageY > Eb && hb.moveSectionDown());
            Eb = a.pageY;
        }
        function D(b, c) {
            var d = c.position(), e = c.index(), f = b.closest(".fp-section"), g = f.index(".fp-section"), i = f.data("anchor"), j = f.find(".fp-slidesNav"), k = U(c), l = nb;
            if (h.onSlideLeave) {
                var m = f.find(".fp-slide.active"), n = m.index(), o;
                o = n == e ? "none" : n > e ? "left" : "right";
                l || "none" === o || a.isFunction(h.onSlideLeave) && h.onSlideLeave.call(m, i, g + 1, n, o);
            }
            c.addClass("active").siblings().removeClass("active");
            !h.loopHorizontal && h.controlArrows && (f.find(".fp-controlArrow.fp-prev").toggle(0 !== e), 
            f.find(".fp-controlArrow.fp-next").toggle(!c.is(":last-child")));
            f.hasClass("active") && S(e, k, i, g);
            var p = function() {
                l || a.isFunction(h.afterSlideLoad) && h.afterSlideLoad.call(c, i, g + 1, k, e);
                ib = !1;
            };
            h.css3 ? (d = "translate3d(-" + d.left + "px, 0px, 0px)", G(b.find(".fp-slidesContainer"), 0 < h.scrollingSpeed).css(bb(d)), 
            setTimeout(function() {
                p();
            ...
            j.find("li").eq(e).find("a").addClass("active");
        }
        function E() {
            F();
            if (jb) {
                var b = a(c.activeElement);
                b.is("textarea") || b.is("input") || b.is("select") || (b = f.height(), d.abs(b - Fb) > 20 * d.max(Fb, b) / 100 && (hb.reBuild(!0), 
                Fb = b));
            } else clearTimeout(Gb), Gb = setTimeout(function() {
                hb.reBuild(!0);
            }, 500);
        }
        function F() {
            if (h.responsive) {
                var b = lb.hasClass("fp-responsive");
                f.width() < h.responsive ? b || (hb.setAutoScrolling(!1, "internal"), hb.setFitToSection(!1, "internal"), 
                a("#fp-nav").hide(), lb.addClass("fp-responsive")) : b && (hb.setAutoScrolling(ub.autoScrolling, "internal"), 
                hb.setFitToSection(ub.autoScrolling, "internal"), a("#fp-nav").show(), lb.removeClass("fp-responsive"));
            }
        }
        function G(a) {
        ...
        function H(a, b) {
            if (825 > a || 900 > b) {
                ...
                gb.css("font-size", c + "%");
            } else gb.css("font-size", "100%");
        }
        function I(b, c) {
            h.menu && (a(h.menu).find(".active").removeClass("active"), a(h.menu).find('[data-menuanchor="' + b + '"]').addClass("active"));
            h.navigation && (a("#fp-nav").find(".active").removeClass("active"), b ? a("#fp-nav").find('a[href="#' + b + '"]').addClass("active") : a("#fp-nav").find("li").eq(c).find("a").addClass("active"));
        }
        function J(b) {
        ...
        function K(a) {
            ...
            var b = a.closest(".fp-section"), c = a.find(".fp-scrollable"), d;
            c.length ? d = c.get(0).scrollHeight : (d = a.get(0).scrollHeight, h.verticalCentered && (d = a.find(".fp-tableCell").get(0).scrollHeight));
            b = mb - parseInt(b.css("padding-bottom")) - parseInt(b.css("padding-top"));
            d > b ? c.length ? c.css("height", b + "px").parent().css("height", b + "px") : (h.verticalCentered ? a.find(".fp-tableCell").wrapInner('<div class="fp-scrollable" />') : a.wrapInner('<div class="fp-scrollable" />'), 
        ...
        function M(a) {
            a.addClass("fp-table").wrapInner('<div class="fp-tableCell" style="height:' + N(a) + 'px;" />');
        }
        function N(a) {
            var b = mb;
            if (h.paddingTop || h.paddingBottom) b = a, b.hasClass("fp-section") || (b = a.closest(".fp-section")), 
            a = parseInt(b.css("padding-top")) + parseInt(b.css("padding-bottom")), b = mb - a;
            return b;
        }
        function O(a, b) {
            b ? G(lb) : lb.addClass("fp-notransition");
            lb.css(bb(a));
            setTimeout(function() {
                lb.removeClass("fp-notransition");
            }, 10);
        }
        function P(b, c) {
            var d;
            ...
            b === ob || d.hasClass("active") ? Q(d, c) : w(d, function() {
                Q(d, c);
            });
        }
        function Q(a, b) {
        ...
        function S(a, b, c, d) {
            d = "";
            h.anchors.length && (a ? ("undefined" !== typeof c && (d = c), "undefined" === typeof b && (b = a), 
            pb = b, T(d + "/" + b)) : ("undefined" !== typeof a && (pb = b), T(c)));
            V();
        }
        function T(a) {
            if (h.recordHistory) location.hash = a; else if (jb || kb) history.replaceState(e, e, "#" + a); else {
        ...
        function V() {
            var b = a(".fp-section.active"), c = b.find(".fp-slide.active"), d = b.data("anchor"), e = U(c), b = b.index(".fp-section"), b = String(b);
            h.anchors.length && (b = d);
            c.length && (b = b + "-" + e);
            b = b.replace("/", "-").replace("#", "");
            gb[0].className = gb[0].className.replace(RegExp("\\b\\s?fp-viewing-[^\\s]+\\b", "g"), "");
            gb.addClass("fp-viewing-" + b);
        }
        function W() {
            var a = c.createElement("p"), d, f = {
            ...
            c.body.insertBefore(a, null);
            for (var g in f) a.style[g] !== e && (a.style[g] = "translate3d(1px,1px,1px)", d = b.getComputedStyle(a).getPropertyValue(f[g]));
            c.body.removeChild(a);
            return d !== e && 0 < d.length && "none" !== d;
        }
        function X() {
            if (jb || kb) {
                var a = Z();
                g.off("touchstart " + a.down).on("touchstart " + a.down, r);
                g.off("touchmove " + a.move).on("touchmove " + a.move, o);
            }
        }
        function Y() {
            if (jb || kb) {
                var a = Z();
                g.off("touchstart " + a.down);
                g.off("touchmove " + a.move);
            }
        }
        function Z() {
        ...
        function $(a) {
            ...
            kb && q(a) && (b.y = a.touches[0].pageY, b.x = a.touches[0].pageX);
            return b;
        }
        function _(a) {
            hb.setScrollingSpeed(0, "internal");
            D(a.closest(".fp-slides"), a);
            hb.setScrollingSpeed(ub.scrollingSpeed, "internal");
        }
        function ab(a) {
            h.scrollBar ? lb.scrollTop(a) : h.css3 ? O("translate3d(0px, -" + a + "px, 0px)", !1) : lb.css("top", -a);
        }
        function bb(a) {
            return {
                "-webkit-transform": a,
        ...
        function cb() {
            ...
            lb.addClass("fp-notransition");
            lb.find(".fp-tableCell, .fp-slidesContainer, .fp-slides").each(function() {
        ...
        var fb = a("html, body"), gb = a("body"), hb = a.fn.fullpage;
        h = a.extend({
            menu: !1,
            anchors: [],
            navigation: !1,
        ...
        (function() {
            h.continuousVertical && (h.loopTop || h.loopBottom) && (h.continuousVertical = !1, 
            eb("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled"));
            h.continuousVertical && h.scrollBar && (h.continuousVertical = !1, eb("warn", "Option `scrollBar` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled"));
            a.each(h.anchors, function(b, c) {
                (a("#" + c).length || a('[name="' + c + '"]').length) && eb("error", "data-anchor tags can not have the same value as any `id` element on the site (or `name` element for IE).");
            });
        })();
        a.extend(a.easing, {
        ...
        hb.setAutoScrolling = function(b, c) {
            db("autoScrolling", b, c);
            var d = a(".fp-section.active");
            h.autoScrolling && !h.scrollBar ? (fb.css({
                overflow: "hidden",
                height: "100%"
            }), hb.setRecordHistory(h.recordHistory, "internal"), lb.css({
                "-ms-touch-action": "none",
                "touch-action": "none"
            }), d.length && ab(d.position().top)) : (fb.css({
                overflow: "visible",
                height: "initial"
            }), hb.setRecordHistory(!1, "internal"), lb.css({
                "-ms-touch-action": "",
                "touch-action": ""
            }), ab(0), d.length && fb.scrollTop(d.position().top));
        };
        hb.setRecordHistory = function(a, b) {
            db("recordHistory", a, b);
        };
        hb.setScrollingSpeed = function(a, b) {
            db("scrollingSpeed", a, b);
        };
        hb.setFitToSection = function(a, b) {
            db("fitToSection", a, b);
        };
        hb.setMouseWheelScrolling = function(a) {
            a ? c.addEventListener ? (c.addEventListener("mousewheel", t, !1), c.addEventListener("wheel", t, !1)) : c.attachEvent("onmousewheel", t) : c.addEventListener ? (c.removeEventListener("mousewheel", t, !1), 
            c.removeEventListener("wheel", t, !1)) : c.detachEvent("onmousewheel", t);
        };
        hb.setAllowScrolling = function(b, c) {
            "undefined" != typeof c ? (c = c.replace(" ", "").split(","), a.each(c, function(a, c) {
                switch (c) {
                  case "up":
                    tb.up = b;
                    break;
                  ...
                  case "all":
                    hb.setAllowScrolling(b);
                }
            })) : b ? (hb.setMouseWheelScrolling(!0), X()) : (hb.setMouseWheelScrolling(!1), 
            Y());
        };
        hb.setKeyboardScrolling = function(a) {
            h.keyboardScrolling = a;
        };
        hb.moveSectionUp = function() {
            var b = a(".fp-section.active").prev(".fp-section");
            b.length || !h.loopTop && !h.continuousVertical || (b = a(".fp-section").last());
            b.length && w(b, null, !0);
        };
        hb.moveSectionDown = function() {
            var b = a(".fp-section.active").next(".fp-section");
            b.length || !h.loopBottom && !h.continuousVertical || (b = a(".fp-section").first());
            b.length && w(b, null, !1);
        };
        hb.moveTo = function(b, c) {
            var d = "", d = isNaN(b) ? a('[data-anchor="' + b + '"]') : a(".fp-section").eq(b - 1);
            "undefined" !== typeof c ? P(b, c) : 0 < d.length && w(d);
        };
        hb.moveSlideRight = function() {
            u("next");
        };
        hb.moveSlideLeft = function() {
            u("prev");
        };
        hb.reBuild = function(b) {
            if (!lb.hasClass("fp-destroyed")) {
                nb = !0;
                var c = f.width();
                mb = f.height();
                h.resize && H(mb, c);
                a(".fp-section").each(function() {
                    var b = a(this).find(".fp-slides"), c = a(this).find(".fp-slide");
                    h.verticalCentered && a(this).find(".fp-tableCell").css("height", N(a(this)) + "px");
                    a(this).css("height", mb + "px");
                    h.scrollOverflow && (c.length ? c.each(function() {
                        K(a(this));
                    }) : K(a(this)));
                    c.length && D(b, b.find(".fp-slide.active"));
                });
                c = a(".fp-section.active");
                c.index(".fp-section") && w(c);
                nb = !1;
                a.isFunction(h.afterResize) && b && h.afterResize.call(lb);
                a.isFunction(h.afterReBuild) && !b && h.afterReBuild.call(lb);
            }
        };
        var ib = !1, jb = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/), kb = "ontouchstart" in b || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints, lb = a(this), mb = f.height(), nb = !1, ob, pb, qb = !0, rb = [], sb, tb = {
            up: !0,
            down: !0,
            left: !0,
            right: !0
        }, ub = a.extend(!0, {}, h);
        hb.setAllowScrolling(!0);
        lb.removeClass("fp-destroyed");
        h.css3 && (h.css3 = W());
        a(this).length ? (lb.css({
            height: "100%",
            position: "relative"
        }), lb.addClass("fullpage-wrapper")) : eb("error", "Error! Fullpage.js needs to be initialized with a selector. For example: $('#myContainer').fullpage();");
        ...
        a(".fp-section").each(function(b) {
            var c = a(this), d = a(this).find(".fp-slide"), e = d.length;
            ...
            "undefined" !== typeof h.sectionsColor[b] && a(this).css("background-color", h.sectionsColor[b]);
            "undefined" !== typeof h.anchors[b] && (a(this).attr("data-anchor", h.anchors[b]), 
            a(this).hasClass("active") && I(h.anchors[b], b));
            if (1 < e) {
                b = 100 * e;
                var f = 100 / e;
                ...
                h.slidesNavigation && R(a(this), e);
                d.each(function(b) {
                    a(this).css("width", f + "%");
                    h.verticalCentered && M(a(this));
                });
                c = c.find(".fp-slide.active");
                c.length ? _(c) : d.eq(0).addClass("active");
            } else h.verticalCentered && M(a(this));
        }).promise().done(function() {
            hb.setAutoScrolling(h.autoScrolling, "internal");
            var d = a(".fp-section.active").find(".fp-slide.active");
            d.length && (0 !== a(".fp-section.active").index(".fp-section") || 0 === a(".fp-section.active").index(".fp-section") && 0 !== d.index()) && _(d);
            h.fixedElements && h.css3 && a(h.fixedElements).appendTo(gb);
            h.navigation && (sb.css("margin-top", "-" + sb.height() / 2 + "px"), sb.find("li").eq(a(".fp-section.active").index(".fp-section")).find("a").addClass("active"));
            h.menu && h.css3 && a(h.menu).closest(".fullpage-wrapper").length && a(h.menu).appendTo(gb);
            h.scrollOverflow ? ("complete" === c.readyState && k(), f.on("load", k)) : a.isFunction(h.afterRender) && h.afterRender.call(lb);
            F();
            if (!h.animateAnchor && (d = b.location.hash.replace("#", "").split("/")[0], d.length)) {
                var e = a('[data-anchor="' + d + '"]');
                e.length && (h.autoScrolling ? ab(e.position().top) : (ab(0), fb.scrollTop(e.position().top)), 
                I(d, null), a.isFunction(h.afterLoad) && h.afterLoad.call(e, d, e.index(".fp-section") + 1), 
        ...
        var vb, wb, xb = !1;
        f.on("scroll", l);
        var yb = 0, zb = 0, Ab = 0, Bb = 0, Cb = new Date().getTime();
        f.on("hashchange", B);
        g.keydown(function(b) {
            clearTimeout(Db);
            var d = a(c.activeElement);
            d.is("textarea") || d.is("input") || d.is("select") || !h.keyboardScrolling || !h.autoScrolling || (-1 < a.inArray(b.which, [ 40, 38, 32, 33, 34 ]) && b.preventDefault(), 
        ...
        var Db;
        lb.mousedown(function(a) {
            2 == a.which && (Eb = a.pageY, lb.on("mousemove", C));
        });
        lb.mouseup(function(a) {
            2 == a.which && lb.off("mousemove");
        });
        var Eb = 0;
        ...
        h.normalScrollElements && (g.on("mouseenter", h.normalScrollElements, function() {
            hb.setMouseWheelScrolling(!1);
        }), g.on("mouseleave", h.normalScrollElements, function() {
            hb.setMouseWheelScrolling(!0);
        }));
        a(".fp-section").on("click touchstart", ".fp-controlArrow", function() {
            a(this).hasClass("fp-prev") ? hb.moveSlideLeft() : hb.moveSlideRight();
        });
        f.resize(E);
        var Fb = mb, Gb;
        hb.destroy = function(b) {
            hb.setAutoScrolling(!1, "internal");
            hb.setAllowScrolling(!1);
            hb.setKeyboardScrolling(!1);
            lb.addClass("fp-destroyed");
            f.off("scroll", l).off("hashchange", B).off("resize", E);
            g.off("click", "#fp-nav a").off("mouseenter", "#fp-nav li").off("mouseleave", "#fp-nav li").off("click", ".fp-slidesNav a").off("mouseover", h.normalScrollElements).off("mouseout", h.normalScrollElements);

      ...
      while(n < x) {
        ...
        if (showInteractionLinks) {
          op += '<p class="interact"><a href="https://twitter.com/intent/' +
              'tweet?in_reply_to=' + tids[n] + '" class="twitter_reply_icon twitter-post"' +
              (targetBlank ? ' target="_blank">' : '>') +
              '</a><a href="https://twitter.com/intent/retweet?tweet_id=' +
              tids[n] + '" class="twitter_retweet_icon twitter-post"' +
              (targetBlank ? ' target="_blank">' : '>') + '</a>' +
              '<a href="https://twitter.com/intent/favorite?tweet_id=' +
              tids[n] + '" class="twitter_fav_icon twitter-post"' +
